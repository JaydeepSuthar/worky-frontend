...
const AddWorker = () => {
    ...
    const modal = useWebStore((state) => state.modal);
    return (
        <>
            {/* Main modal */}
            <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                <div
                    ...
                    className={`${
                        modal ? "" : "hidden"
                    } overflow-y-auto  overflow-x-hidden z-50 justify-center items-center w-[500px] md:inset-0 h-[calc(100%-1rem)] max-h-full `}
                >
